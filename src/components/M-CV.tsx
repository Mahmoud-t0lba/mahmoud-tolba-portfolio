...
const cvCardClass = 'rounded-[28px] border border-black/5 bg-white/40 p-7 dark:border-white/8 dark:bg-white/4 md:p-9';
    ...
    return createPortal(
        <>
            ...
            <div className="fixed inset-0 z-[1501] flex items-center justify-center p-4 md:p-8 pointer-events-none">
                ...
                >
                    <div className="shrink-0 px-6 pb-0 pt-6 md:px-10 md:pt-10">
                        <div className="mb-10 flex items-start justify-between gap-5 md:mb-12">
                    ...
                    <div className="custom-scrollbar flex-1 overflow-y-auto px-4 py-5 md:px-10 md:py-6">
                        <div className="mx-auto max-w-5xl space-y-20 pb-16">
                            <header className="space-y-14">
                                ...
                                <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                                    <a href={`mailto:${personalInfo.email}`} className="rounded-[26px] border border-black/5 bg-white/45 p-6 transition-colors hover:text-blue-500 dark:border-white/8 dark:bg-white/4 md:p-7">
                                        <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.24em] text-blue-500">
                                            <Mail size={14} />
                                            Email
                                        </div>
                                        <div className="mt-5 text-sm font-semibold leading-7 text-primary break-all">{personalInfo.email}</div>
                                    </a>
                                    <a href={`tel:${personalInfo.phone.replace(/\s+/g, '')}`} className="rounded-[26px] border border-black/5 bg-white/45 p-6 transition-colors hover:text-blue-500 dark:border-white/8 dark:bg-white/4 md:p-7">
                                        <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.24em] text-blue-500">
                                            <Phone size={14} />
                                            Call
                                        </div>
                                        <div className="mt-5 text-sm font-semibold leading-7 text-primary">{personalInfo.phone}</div>
                                    </a>
                                    <div className="rounded-[26px] border border-black/5 bg-white/45 p-6 dark:border-white/8 dark:bg-white/4 md:p-7">
                                        <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.24em] text-blue-500">
                                            <MapPin size={14} />
                                            Location
                                        </div>
                                        <div className="mt-5 text-sm font-semibold leading-7 text-primary">{personalInfo.location}</div>
                                    </div>
                                    <a
                                        href={personalInfo.resumeUrl}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="rounded-[26px] border border-black/5 bg-white/45 p-6 transition-colors hover:text-blue-500 dark:border-white/8 dark:bg-white/4 md:p-7"
                                    >
                                        <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.24em] text-blue-500">
                                            <Download size={14} />
                                            Resume
                                        </div>
                                        <div className="mt-5 text-sm font-semibold leading-7 text-primary">Open PDF version</div>
                                    </a>
                                </div>
                                ...
                                <div className="grid gap-8 lg:grid-cols-[1.35fr_0.95fr]">
                                    <section className={cvCardClass}>
                                        <div className="space-y-7">
                                            ...
                                            <p className="pt-2 text-base leading-9 text-sec md:text-lg">
                                                {personalInfo.bio}
                                            </p>
                                        </div>
                                    </section>
                                            ...
                                            <div className="grid gap-5 pt-2">
                                                {socialLinks.map((link) => (
                                                    <a
                                                        ...
                                                        className="flex items-center gap-4 rounded-2xl border border-black/5 bg-white/45 px-5 py-4 text-sm font-bold text-sec transition-all hover:border-blue-500/20 hover:text-blue-500 dark:border-white/8 dark:bg-white/4"
                                                    >
                            ...
                            <div className="grid gap-16 lg:grid-cols-[1.45fr_0.95fr] xl:gap-16">
                                <div className="space-y-20">
                                    <section className="space-y-8">
                                        <h3 className={sectionTitleClass}>Resume Snapshot</h3>
                                        <div className="grid gap-6 sm:grid-cols-2">
                                            {resumeHighlights.map((item) => (
                                                <div key={item} className="rounded-[26px] border border-black/5 bg-white/45 p-6 dark:border-white/8 dark:bg-white/4">
                                        ...
                                        <div className="grid gap-7 md:grid-cols-2">
                                            {projects.map((project) => (
                                                <motion.div
                                                    ...
                                                    className="group cursor-pointer rounded-[28px] border border-black/5 bg-white/40 p-6 dark:border-white/8 dark:bg-white/4 md:p-7"
                                                >
                                                    <div className="space-y-6">
                                ...
                                <aside className="space-y-14">
                                    <section className="space-y-8">
                                        ...
                                        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-1">
                                            {localTags.map((skill) => (
                                                <div key={skill.name} className="rounded-[24px] border border-black/5 bg-white/40 p-6 dark:border-white/8 dark:bg-white/4">
                                    ...
                                    <section className="space-y-8">
                                        ...
                                        <div className="space-y-7">
                                            {education.map((item) => (
                                                <div key={item.title} className="rounded-[26px] border border-black/5 bg-white/40 p-6 dark:border-white/8 dark:bg-white/4 md:p-7">
                                    ...
                                    <section className="space-y-8">
                                        ...
                                        <div className="space-y-6">
                                            {certifications.map((item) => (
                                                <div key={item.title} className="rounded-[24px] border border-black/5 bg-white/40 p-6 dark:border-white/8 dark:bg-white/4">
